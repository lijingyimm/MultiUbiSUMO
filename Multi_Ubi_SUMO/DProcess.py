...
def convertRawToXY(rawDataFrame, refMatrFileName="", nb_windows=3, codingMode=0):#rawDataFrame is numpy.ndarray
    ...
    # print('rawDataFrame',rawDataFrame)
    targetArr = rawDataFrame[:,0:2]
    # target = []
    # for i in range(len(targetArr)):
    #     if targetArr[i][0] == 0 and targetArr[i][1]== 0:
    #         target.append(0)
    #     if targetArr[i][0] == 1 and targetArr[i][1]== 0:
    #         target.append(1)
    #     if targetArr[i][0] == 0 and targetArr[i][1]== 1:
    #         target.append(2)
    #     if targetArr[i][0] == 1 and targetArr[i][1]== 1:
    #         target.append(3)
        # print('targetArr',targetArr[i])
    # targetArr[targetArr==[0 0]]= 0
    # targetArr[targetArr==[1 0]] = 1
    # targetArr[targetArr==[0 1]] = 2
    # targetArr[targetArr==[1 1]] = 3

    # targetList[np.where(targetList==2)] = 0
    # print('targetList',targetList[1:100])
    # targetArr = kutils.to_categorical(targetList,2)
    # print('targetArr',targetArr)
    # print('target',target)
    sampleSeq3DArr = rawDataFrame[:, 1:]
    # print('sampleSeq3DArr',sampleSeq3DArr)
    ...
    for sequence in sampleSeq3DArr:
        ...
        for AA in sequence:
            ...
            if not AA in letterDict:
                ...
                # print('probMatr[sampleNo][0][AANo]',probMatr[sampleNo][0][AANo])
